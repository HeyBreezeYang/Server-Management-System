package com.system.started.action.impl.system;
...
import com.vlandc.oss.kernel.system.ISystemService;
...
public class SystemActionImpl implements ISystemAction {
	...
	@Autowired
	private ISystemService kernelSystemService;
	...
	public Result doExcutionAction(String loginId, String projectId, EAction action, HashMap<String, Object> actionParam) {
		...
		return kernelSystemService.doExcutionAction(virtualUserObject, action, actionParam);
	}

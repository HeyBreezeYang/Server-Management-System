...
public class ElasticsearchConfig {
     ...
     * elk集群地址
     */
    @Value("${oss.apigate.elasticsearch.ip}")
    private String hostName;
    
    /**
     * 端口
     */
    @Value("${oss.apigate.elasticsearch.port}")
    private String port;
    
    /**
     * 集群名称
     */
    @Value("${oss.apigate.elasticsearch.cluster.name}")
    private String clusterName;

    /**
     * 连接池
     */
    @Value("${oss.apigate.elasticsearch.pool}")

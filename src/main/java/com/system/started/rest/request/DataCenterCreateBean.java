...
@ApiModel(description="创建机房对象")
public class DataCenterCreateBean implements Serializable{
	...
	@ApiModelProperty(value="数据中心ID，<br>例子：1", dataType="integer", required=true)
